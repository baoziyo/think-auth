...
class Data
{
     ...
     * @param string $fieldPid 父ID键名a
     * @param int    $level    不需要传参数（执行时调用）
     *
     * @return array
     */
    public static function channelLevel($datas, $pid = 0, $html = '&nbsp;', $fieldPri = 'id', $fieldPid = 'pid', $level = 1)
    {
        if (empty($datas)) {
            return [];
        }
     ...
     * @return array
     */
    public static function channelList($datas, $pid = 0, $html = '&nbsp;', $fieldPri = 'id', $fieldPid = 'pid', $level = 1)
    {
    ...
    //只供channelList方法使用
    private static function _channelList($datas, $pid = 0, $html = '&nbsp;', $fieldPri = 'id', $fieldPid = 'pid', $level = 1)
    {
        if (empty($datas)) {
            return [];
        }
     ...
     * @return array
     */
    public static function tree($datas, $title, $fieldPri = 'id', $fieldPid = 'pid')
    {
     ...
     * @return array
     */
    public static function parentChannel($datas, $sid, $fieldPri = 'id', $fieldPid = 'pid')
    {
        if (empty($datas)) {
            return $datas;
        }
     ...
     * @return bool
     */
    public static function isChild($datas, $sid, $pid, $fieldPri = 'id', $fieldPid = 'pid')
    {
     ...
     * @return bool
     */
    public static function hasChild($datas, $cid, $fieldPid = 'pid')
    {
        foreach ($datas as $data) {
